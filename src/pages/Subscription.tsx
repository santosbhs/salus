        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-black">Flash Clinic</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          {plans.map((plan) => (
            <Card 
              ...
              className={`relative hover:shadow-xl transition-all duration-300 ${
                plan.popular ? 'ring-2 ring-black scale-105' : 'hover:scale-105'
              }`}
            >
              {plan.popular && (
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm">
          <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">
            Por que escolher o Flash Clinic?
          </h3>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-12 h-12 bg-gradient-to-r from-black to-gray-800 rounded-lg flex items-center justify-center mx-auto mb-4">
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 mb-4">
            Já é assinante? 
            <Link to="/login" className="text-black font-medium hover:underline ml-1">
              Faça login aqui
            </Link>
          </p>
        </div>
