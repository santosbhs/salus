  ...
  return (
    <section className="py-20 px-4 overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-r from-green-400/20 to-emerald-400/20 rounded-full animate-pulse"></div>
        <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-r from-emerald-400/30 to-green-400/30 rounded-full animate-bounce"></div>
        <div className="absolute bottom-20 left-1/4 w-20 h-20 bg-gradient-to-r from-green-500/25 to-emerald-500/25 rounded-full animate-ping"></div>
      </div>
      ...
      <div className="container mx-auto max-w-4xl text-center relative z-10">
        ...
        <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-green-700 to-emerald-700 bg-clip-text text-transparent leading-tight animate-fade-in">
          Modernize sua clínica com tecnologia de ponta
        </h1>
        <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto animate-fade-in">
        ...
        <div className="flex items-center justify-center space-x-8 text-sm text-gray-500 animate-fade-in">
