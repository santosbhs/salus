  ...
  return (
    <section className="py-20 px-4 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-10 right-10 w-40 h-40 bg-gradient-to-r from-green-100 to-emerald-100 rounded-full opacity-50 animate-pulse"></div>
        <div className="absolute bottom-20 left-20 w-60 h-60 bg-gradient-to-r from-emerald-100 to-green-100 rounded-full opacity-30 animate-bounce"></div>
      </div>
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-500 border hover:border-green-200 transform hover:-translate-y-2 animate-fade-in">
